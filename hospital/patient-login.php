...
<form class="form" action="validate-patient.php" method="post" autocomplete="off">
  <div class="form-inner">
    ...
    <div class="input-wrapper">
      ...
      <div class="input-group"><span class="icon">
        ...
        <input type="email" id="login-username" name= 'email' data-lpignore="true" required/>
      </div>
    </div>
     <!--<div class="input">
        <div class="title"> USERNAME</div>
    ...
    <div class="input-wrapper">
      ...
      <div class="input-group"><span class="icon">
        ...
        <input type="password" id="login-password" name = 'password' data-lpignore="true" rquired/>
      </div>
       <!--<div class="input">
        <div class="title"> USERNAME</div>
        <input class="text" type="text" placeholder=""/>
    ...
    <div class="button-group">
        ...
        <input  class="bsk btn--primary--mod btn--text--mod" style="width:35%;" type="submit" name="submit" value="Sign In">
    </div>
